    ...
    <div className="submit-layout">
      <div className="submit-form">
        ...
        <div className="submit-form__message submit-form__message--success" role="status">
          ...
          <p>Use this page to shape the slogan and template only. The public submit queue is intentionally offline for launch.</p>
        </div>
      ...
      <aside className="submit-preview-panel">
        <div className="section-heading section-heading--compact">
          ...
          <p className="section-heading__description">
            Current template: {selectedTemplate.label}. The preview still updates as you type.
          </p>
        </div>
